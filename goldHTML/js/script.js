...
(function () {
	...
	// jQuery({ Counter: 0 }).animate({ Counter: $('.tests').text() }, {
	// 	duration: 5000,
	// 	step: function () {
	// 		$('.tests').text(Math.ceil(this.Counter));
	// 	}
	// });
...
jQuery(document).ready(function ($) {
	...
	function checkIfInView() {
		$(".Single, .test, .tests").each(function () {
			let element = $(this);
	...
	checkIfInView(); // Run once in case the element is already in view
});
